...
[![GitHub release](https://img.shields.io/github/release/parfaitementweb/laravel-localized-routes.svg?style=flat-square)](https://github.com/parfaitementweb/laravel-localized-routes/releases)
[![Laravel](https://img.shields.io/badge/laravel-12%20%7C%2013-red?style=flat-square&logo=laravel&logoColor=white)](https://laravel.com)
[![License](https://img.shields.io/packagist/l/parfaitementweb/laravel-localized-routes.svg?style=flat-square)](LICENSE.md)
[![Build Status](https://img.shields.io/github/actions/workflow/status/parfaitementweb/laravel-localized-routes/run-tests.yml?style=flat-square&logo=github&logoColor=white&label=tests)](https://github.com/parfaitementweb/laravel-localized-routes/actions)
[![Total Downloads](https://img.shields.io/packagist/dt/parfaitementweb/laravel-localized-routes.svg?style=flat-square)](https://packagist.org/packages/parfaitementweb/laravel-localized-routes)

[![ko-fi](https://www.ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/R6R3UQ8V)

A convenient way to set up and use localized routes in a Laravel app.

> **Maintained fork.** This is a community-maintained fork of the original
> [codezero-be/laravel-localized-routes](https://github.com/codezero-be/laravel-localized-routes)
> by Ivan Vermeyen, updated to support Laravel 12 and 13. All credit for the
> original work goes to the CodeZero team.
...
```bash
composer require parfaitementweb/laravel-localized-routes
```
...
This package includes [parfaitementweb/laravel-uri-translator](https://github.com/parfaitementweb/laravel-uri-translator).
